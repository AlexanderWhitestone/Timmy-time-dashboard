...
async def test_system_prompt_selection():
    ...
    # Both should mention the assistant role
    assert "local AI assistant" in prompt_with_tools, "Prompt should describe the assistant"
    assert "local AI assistant" in prompt_without_tools, "Prompt should describe the assistant"
